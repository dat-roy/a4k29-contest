    ...
    <table>
        ...
        <tbody>
            ...
            <?php 
                ...
                $query = mysqli_query($conn,"SELECT * FROM ketqua_luyentap_$p");
                while ($row = mysqli_fetch_array($query)) { 

                    $userid = $row['idthisinh'];
            ...
            <?php 
                ...
                $sql = mysqli_query($conn, "SELECT * FROM danhsach_luyentap WHERE idluyentap = $p");
                $row = mysqli_fetch_array($sql);
                $max_score = $row['socauhoi'];

                $query = mysqli_query($conn,"SELECT * FROM ketqua_luyentap_$p ORDER BY socaudung DESC, thoigiannop ASC");
                $index = 0;
                while ($row = mysqli_fetch_array($query)){ 
                    ...
                    $userid = $row['idthisinh'];
                    $sql_select = mysqli_query($conn,"SELECT * FROM user WHERE id = $userid");
                    ...
                    if  ($score == $score_before) $rank = $rank_before;
                    else $rank = $index;
