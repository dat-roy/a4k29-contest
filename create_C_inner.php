<h1 style='text-align: center;'>Tạo Cuộc Thi Mới:</h1>
    <form action="upload_C.php" method = "POST" enctype="multipart/form-data">
            <h2 id='buoc1'> Bước 1: </h2>
            <label for="tencuocthi">Nhập tên bài: </label><input type="text" placeholder = "Tên bài" name="tencuocthi" id="tencuocthi" required>
            <br>
