...
<html>
<head>
	<title>Bảng Xếp Hạng Luyện Tập</title>
	<meta charset="UTF-8">
...
<body>
	...
	<?php 
		/* Kiểm tra bài luyện tập đã kết thúc hay chưa */
		...
		if (mysqli_num_rows($query) > 0) {
		 ...
		 if (($now - $end_time_stamp) < 0){
			echo "<span style='margin-top: 80px; font-size: 20px; font-weight: 600; text-align: center'> BXH chưa được cập nhật do chưa hết thời gian quy định. </span>";
		 }
		 else {
			require 'leaderboard_P_inner.php';
		 }
	?>
